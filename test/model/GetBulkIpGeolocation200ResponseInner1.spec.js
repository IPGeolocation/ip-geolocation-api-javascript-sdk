...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkIPGeolocationResponse1();
  });
  ...
  describe('BulkIPGeolocationResponse1', function() {
    it('should create an instance of BulkIPGeolocationResponse1', function() {
      // uncomment below and update the code to test BulkIPGeolocationResponse1
      //var instance = new BulkIPGeolocationResponse1();
      //expect(instance).to.be.a(BulkIPGeolocationResponse1);
    });
