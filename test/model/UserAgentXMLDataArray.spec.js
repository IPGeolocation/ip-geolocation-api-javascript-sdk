...
(function(root, factory) {
  ...
  describe('UserAgentXMLDataArray', function() {
    it('should create an instance of UserAgentXMLDataArray', function() {
      // uncomment below and update the code to test UserAgentXMLDataArray
      //var instance = new UserAgentXMLDataArray();
      //expect(instance).to.be.a(UserAgentXMLDataArray);
    });
