...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkIPGeolocationResponse();
  });
  ...
  describe('BulkIPGeolocationResponse', function() {
    it('should create an instance of BulkIPGeolocationResponse', function() {
      // uncomment below and update the code to test BulkIPGeolocationResponse
      //var instance = new BulkIPGeolocationResponse();
      //expect(instance).to.be.a(BulkIPGeolocationResponse);
    });
