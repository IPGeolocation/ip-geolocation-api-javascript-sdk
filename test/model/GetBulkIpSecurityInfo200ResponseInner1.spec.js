...
(function(root, factory) {
  ...
  describe('BulkIPSecurityResponse1', function() {
    it('should create an instance of BulkIPSecurityResponse1', function() {
      // uncomment below and update the code to test BulkIPSecurityResponse1
      //var instance = new BulkIPSecurityResponse1();
      //expect(instance).to.be.a(BulkIPSecurityResponse1);
    });
