...
(function(root, factory) {
  ...
  describe('SecurityAPIXMLResponse', function() {
    it('should create an instance of SecurityAPIXMLResponse', function() {
      // uncomment below and update the code to test SecurityAPIXMLResponse
      //var instance = new SecurityAPIXMLResponse();
      //expect(instance).to.be.a(SecurityAPIXMLResponse);
    });
