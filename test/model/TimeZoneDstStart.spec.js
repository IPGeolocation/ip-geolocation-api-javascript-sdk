...
(function(root, factory) {
  ...
  describe('TimeZoneDstStart', function() {
    it('should create an instance of TimeZoneDstStart', function() {
      // uncomment below and update the code to test TimeZoneDstStart
      //var instance = new TimeZoneDstStart();
      //expect(instance).to.be.a(TimeZoneDstStart);
    });
