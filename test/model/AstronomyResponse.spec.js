...
(function(root, factory) {
  ...
  describe('AstronomyResponse', function() {
    it('should create an instance of AstronomyResponse', function() {
      // uncomment below and update the code to test AstronomyResponse
      //var instance = new AstronomyResponse();
      //expect(instance).to.be.a(AstronomyResponse);
    });
