...
(function(root, factory) {
  ...
  describe('AbuseResponse', function() {
    it('should create an instance of AbuseResponse', function() {
      // uncomment below and update the code to test AbuseResponse
      //var instance = new AbuseResponse();
      //expect(instance).to.be.a(AbuseResponse);
    });
