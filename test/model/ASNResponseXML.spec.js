...
(function(root, factory) {
  ...
  describe('ASNResponseXML', function() {
    it('should create an instance of ASNResponseXML', function() {
      // uncomment below and update the code to test ASNResponseXML
      //var instance = new ASNResponseXML();
      //expect(instance).to.be.a(ASNResponseXML);
    });
