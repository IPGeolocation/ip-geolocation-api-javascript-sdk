...
(function(root, factory) {
  ...
  describe('NetworkMinimalAsn', function() {
    it('should create an instance of NetworkMinimalAsn', function() {
      // uncomment below and update the code to test NetworkMinimalAsn
      //var instance = new NetworkMinimalAsn();
      //expect(instance).to.be.a(NetworkMinimalAsn);
    });
