...
(function(root, factory) {
  ...
  describe('GeolocationXMLResponseArray', function() {
    it('should create an instance of GeolocationXMLResponseArray', function() {
      // uncomment below and update the code to test GeolocationXMLResponseArray
      //var instance = new GeolocationXMLResponseArray();
      //expect(instance).to.be.a(GeolocationXMLResponseArray);
    });
