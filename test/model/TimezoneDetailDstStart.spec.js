...
(function(root, factory) {
  ...
  describe('TimezoneDetailDstStart', function() {
    it('should create an instance of TimezoneDetailDstStart', function() {
      // uncomment below and update the code to test TimezoneDetailDstStart
      //var instance = new TimezoneDetailDstStart();
      //expect(instance).to.be.a(TimezoneDetailDstStart);
    });
