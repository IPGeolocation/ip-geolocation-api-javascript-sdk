...
(function(root, factory) {
  ...
  describe('TimezoneDetailDstEnd', function() {
    it('should create an instance of TimezoneDetailDstEnd', function() {
      // uncomment below and update the code to test TimezoneDetailDstEnd
      //var instance = new TimezoneDetailDstEnd();
      //expect(instance).to.be.a(TimezoneDetailDstEnd);
    });
