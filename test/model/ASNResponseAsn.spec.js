...
(function(root, factory) {
  ...
  describe('ASNDetails', function() {
    it('should create an instance of ASNDetails', function() {
      // uncomment below and update the code to test ASNDetails
      //var instance = new ASNDetails();
      //expect(instance).to.be.a(ASNDetails);
    });
