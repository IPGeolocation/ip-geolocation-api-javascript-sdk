...
(function(root, factory) {
  ...
  describe('LocationMinimal', function() {
    it('should create an instance of LocationMinimal', function() {
      // uncomment below and update the code to test LocationMinimal
      //var instance = new LocationMinimal();
      //expect(instance).to.be.a(LocationMinimal);
    });
