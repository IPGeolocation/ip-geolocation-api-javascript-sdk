...
(function(root, factory) {
  ...
  describe('BulkIPRequest', function() {
    it('should create an instance of BulkIPRequest', function() {
      // uncomment below and update the code to test BulkIPRequest
      //var instance = new BulkIPRequest();
      //expect(instance).to.be.a(BulkIPRequest);
    });
