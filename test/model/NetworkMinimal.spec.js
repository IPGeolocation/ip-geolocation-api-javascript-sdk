...
(function(root, factory) {
  ...
  describe('NetworkMinimal', function() {
    it('should create an instance of NetworkMinimal', function() {
      // uncomment below and update the code to test NetworkMinimal
      //var instance = new NetworkMinimal();
      //expect(instance).to.be.a(NetworkMinimal);
    });
