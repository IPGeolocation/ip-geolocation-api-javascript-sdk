...
(function(root, factory) {
  ...
  describe('SecurityAPIResponse', function() {
    it('should create an instance of SecurityAPIResponse', function() {
      // uncomment below and update the code to test SecurityAPIResponse
      //var instance = new SecurityAPIResponse();
      //expect(instance).to.be.a(SecurityAPIResponse);
    });
