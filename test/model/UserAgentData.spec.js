...
(function(root, factory) {
  ...
  describe('UserAgentData', function() {
    it('should create an instance of UserAgentData', function() {
      // uncomment below and update the code to test UserAgentData
      //var instance = new UserAgentData();
      //expect(instance).to.be.a(UserAgentData);
    });
