...
(function(root, factory) {
  ...
  describe('GeolocationXMLResponse', function() {
    it('should create an instance of GeolocationXMLResponse', function() {
      // uncomment below and update the code to test GeolocationXMLResponse
      //var instance = new GeolocationXMLResponse();
      //expect(instance).to.be.a(GeolocationXMLResponse);
    });
