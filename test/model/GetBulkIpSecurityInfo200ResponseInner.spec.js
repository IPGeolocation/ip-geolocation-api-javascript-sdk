...
(function(root, factory) {
  ...
  describe('BulkIPSecurityResponse', function() {
    it('should create an instance of BulkIPSecurityResponse', function() {
      // uncomment below and update the code to test BulkIPSecurityResponse
      //var instance = new BulkIPSecurityResponse();
      //expect(instance).to.be.a(BulkIPSecurityResponse);
    });
