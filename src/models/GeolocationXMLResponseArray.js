...
/**
 * The GeolocationXMLResponseArray model module.
 * @module models/GeolocationXMLResponseArray
 * @version 2.0
 */
class GeolocationXMLResponseArray {
    /**
     * Constructs a new <code>GeolocationXMLResponseArray</code>.
     * @alias module:models/GeolocationXMLResponseArray
     */
    constructor() { 
        
        GeolocationXMLResponseArray.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GeolocationXMLResponseArray</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/GeolocationXMLResponseArray} obj Optional instance to populate.
     * @return {module:models/GeolocationXMLResponseArray} The populated <code>GeolocationXMLResponseArray</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeolocationXMLResponseArray();
    ...
    /**
     * Validates the JSON data with respect to <code>GeolocationXMLResponseArray</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeolocationXMLResponseArray</code>.
     */
 ...
 * @member {String} ip
 */
GeolocationXMLResponseArray.prototype['ip'] = undefined;

/**
 * @member {String} hostname
 */
GeolocationXMLResponseArray.prototype['hostname'] = undefined;

/**
 * @member {String} domain
 */
GeolocationXMLResponseArray.prototype['domain'] = undefined;

/**
 * @member {module:models/Location} location
 */
GeolocationXMLResponseArray.prototype['location'] = undefined;

/**
 * @member {module:models/CountryMetadata} country_metadata
 */
GeolocationXMLResponseArray.prototype['country_metadata'] = undefined;

/**
 * @member {module:models/Network} network
 */
GeolocationXMLResponseArray.prototype['network'] = undefined;

/**
 * @member {module:models/Currency} currency
 */
GeolocationXMLResponseArray.prototype['currency'] = undefined;

/**
 * @member {module:models/Security} security
 */
GeolocationXMLResponseArray.prototype['security'] = undefined;

/**
 * @member {module:models/Abuse} abuse
 */
GeolocationXMLResponseArray.prototype['abuse'] = undefined;

/**
 * @member {module:models/TimeZone} time_zone
 */
GeolocationXMLResponseArray.prototype['time_zone'] = undefined;

/**
 * @member {module:models/UserAgentData} user_agent
 */
GeolocationXMLResponseArray.prototype['user_agent'] = undefined;
...
module.exports = GeolocationXMLResponseArray;
