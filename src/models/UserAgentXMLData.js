...
/**
 * The UserAgentXMLData model module.
 * @module models/UserAgentXMLData
 * @version 2.0
 */
class UserAgentXMLData {
    /**
     * Constructs a new <code>UserAgentXMLData</code>.
     * @alias module:models/UserAgentXMLData
     */
    constructor() { 
        
        UserAgentXMLData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserAgentXMLData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/UserAgentXMLData} obj Optional instance to populate.
     * @return {module:models/UserAgentXMLData} The populated <code>UserAgentXMLData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserAgentXMLData();
    ...
    /**
     * Validates the JSON data with respect to <code>UserAgentXMLData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserAgentXMLData</code>.
     */
 ...
 */
UserAgentXMLData.prototype['user_agent_string'] = undefined;

/**
 * @member {String} name
 */
UserAgentXMLData.prototype['name'] = undefined;

/**
 * @member {String} type
 */
UserAgentXMLData.prototype['type'] = undefined;

/**
 * @member {String} version
 */
UserAgentXMLData.prototype['version'] = undefined;

/**
 * @member {String} version_major
 */
UserAgentXMLData.prototype['version_major'] = undefined;

/**
 * @member {module:models/UserAgentDataDevice} device
 */
UserAgentXMLData.prototype['device'] = undefined;

/**
 * @member {module:models/UserAgentDataEngine} engine
 */
UserAgentXMLData.prototype['engine'] = undefined;

/**
 * @member {module:models/UserAgentDataOperatingSystem} operating_system
 */
UserAgentXMLData.prototype['operating_system'] = undefined;
...
module.exports = UserAgentXMLData;
