...
/**
 * The GeolocationResponse model module.
 * @module models/GeolocationResponse
 * @version 2.0
 */
class GeolocationResponse {
    /**
     * Constructs a new <code>GeolocationResponse</code>.
     * @alias module:models/GeolocationResponse
     */
    constructor() { 
        
        GeolocationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GeolocationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/GeolocationResponse} obj Optional instance to populate.
     * @return {module:models/GeolocationResponse} The populated <code>GeolocationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeolocationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GeolocationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeolocationResponse</code>.
     */
 ...
 * @member {String} ip
 */
GeolocationResponse.prototype['ip'] = undefined;

/**
 * @member {String} hostname
 */
GeolocationResponse.prototype['hostname'] = undefined;

/**
 * @member {String} domain
 */
GeolocationResponse.prototype['domain'] = undefined;

/**
 * @member {module:models/Location} location
 */
GeolocationResponse.prototype['location'] = undefined;

/**
 * @member {module:models/CountryMetadata} country_metadata
 */
GeolocationResponse.prototype['country_metadata'] = undefined;

/**
 * @member {module:models/Network} network
 */
GeolocationResponse.prototype['network'] = undefined;

/**
 * @member {module:models/Currency} currency
 */
GeolocationResponse.prototype['currency'] = undefined;

/**
 * @member {module:models/Security} security
 */
GeolocationResponse.prototype['security'] = undefined;

/**
 * @member {module:models/Abuse} abuse
 */
GeolocationResponse.prototype['abuse'] = undefined;

/**
 * @member {module:models/TimeZone} time_zone
 */
GeolocationResponse.prototype['time_zone'] = undefined;

/**
 * @member {module:models/UserAgentData} user_agent
 */
GeolocationResponse.prototype['user_agent'] = undefined;
...
module.exports = GeolocationResponse;
