...
/**
 * The SecurityAPIXMLResponse model module.
 * @module models/SecurityAPIXMLResponse
 * @version 2.0
 */
class SecurityAPIXMLResponse {
    /**
     * Constructs a new <code>SecurityAPIXMLResponse</code>.
     * @alias module:models/SecurityAPIXMLResponse
     */
    constructor() { 
        
        SecurityAPIXMLResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SecurityAPIXMLResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/SecurityAPIXMLResponse} obj Optional instance to populate.
     * @return {module:models/SecurityAPIXMLResponse} The populated <code>SecurityAPIXMLResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SecurityAPIXMLResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SecurityAPIXMLResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SecurityAPIXMLResponse</code>.
     */
 ...
 * @member {String} ip
 */
SecurityAPIXMLResponse.prototype['ip'] = undefined;

/**
 * @member {String} hostname
 */
SecurityAPIXMLResponse.prototype['hostname'] = undefined;

/**
 * @member {module:models/Security} security
 */
SecurityAPIXMLResponse.prototype['security'] = undefined;

/**
 * @member {module:models/LocationMinimal} location
 */
SecurityAPIXMLResponse.prototype['location'] = undefined;

/**
 * @member {module:models/NetworkMinimal} network
 */
SecurityAPIXMLResponse.prototype['network'] = undefined;

/**
 * @member {module:models/TimeZone} time_zone
 */
SecurityAPIXMLResponse.prototype['time_zone'] = undefined;

/**
 * @member {module:models/UserAgentData} user_agent
 */
SecurityAPIXMLResponse.prototype['user_agent'] = undefined;

/**
 * @member {module:models/CountryMetadata} country_metadata
 */
SecurityAPIXMLResponse.prototype['country_metadata'] = undefined;

/**
 * @member {module:models/Currency} currency
 */
SecurityAPIXMLResponse.prototype['currency'] = undefined;
...
module.exports = SecurityAPIXMLResponse;
