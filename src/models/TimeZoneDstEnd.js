...
/**
 * The TimeZoneDstEnd model module.
 * @module models/TimeZoneDstEnd
 * @version 2.0
 */
class TimeZoneDstEnd {
    /**
     * Constructs a new <code>TimeZoneDstEnd</code>.
     * @alias module:models/TimeZoneDstEnd
     */
    constructor() { 
        
        TimeZoneDstEnd.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeZoneDstEnd</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/TimeZoneDstEnd} obj Optional instance to populate.
     * @return {module:models/TimeZoneDstEnd} The populated <code>TimeZoneDstEnd</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeZoneDstEnd();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeZoneDstEnd</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeZoneDstEnd</code>.
     */
 ...
 */
TimeZoneDstEnd.prototype['utc_time'] = undefined;

/**
 * @member {String} duration
 */
TimeZoneDstEnd.prototype['duration'] = undefined;

/**
 * @member {Boolean} gap
 */
TimeZoneDstEnd.prototype['gap'] = undefined;

/**
 * @member {String} date_time_after
 */
TimeZoneDstEnd.prototype['date_time_after'] = undefined;

/**
 * @member {String} date_time_before
 */
TimeZoneDstEnd.prototype['date_time_before'] = undefined;

/**
 * @member {Boolean} overlap
 */
TimeZoneDstEnd.prototype['overlap'] = undefined;
